      ...
      <div className="footer-gradient-block px-3 pt-10 pb-[60px] md:px-7 md:pt-[100px] md:pb-[60px] flex flex-col gap-10 md:gap-[200px] w-full box-border" style={{
        ...
        <div className="flex flex-col gap-10 relative z-10">
          ...
          <div className="flex flex-col gap-8">
            ...
            {/* Mobile Button */}
            <a href="#contact" className="md:hidden flex items-center justify-between w-full h-[52px] rounded-[2px] overflow-hidden" style={{ background: colors.white, textDecoration: 'none' }}>
              <span className="flex items-center h-full pl-4" style={{ ...textStyles.bodyMedium, color: '#CC4D22' }}>Get in touch</span>
              <div className="flex items-center justify-center h-[52px] w-[52px] shrink-0" style={{ borderLeft: '1px solid rgba(204, 77, 34, 0.15)' }}>
